        ...
        <div className="relative z-20 mx-auto max-w-5xl rounded-[40px] py-6 md:p-10 xl:py-20">
          ...
          <div className="space-y-4 md:space-y-6">
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Мы специализируемся на защите и уходе за автомобилями в Казани. Каждый мастер — профессионал с опытом от 5 лет, сертифицированный по работе с PPF-плёнками ведущих брендов.
            </p>
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Работаем с автомобилями любых марок и классов — от городских хэтчбеков до суперкаров. Дорожим репутацией и даём письменную гарантию на все виды работ.
            </p>
          </div>
        </div>
      </div>
